...
export class ViewFile {
  ...
  public createDemoViews() {
    ...
    this.createFiles(
      this.snakeCasedFileName + "_mobile.dart",
      new Mobile(this.snakeCasedFileName, "Mobile").demoString
    );
    this.createFiles(
      this.snakeCasedFileName + "_desktop.dart",
      new Desktop(this.snakeCasedFileName, "Desktop").demoString
    );
    this.createFiles(
      this.snakeCasedFileName + "_tablet.dart",
      new Tablet(this.snakeCasedFileName, "Tablet").demoString
    );
    this.createFiles(
  ...
  public createMobile() {
    this.createFiles(
      this.snakeCasedFileName + "_mobile.dart",
      new Mobile(this.snakeCasedFileName, "Mobile").dartString
    );
  }
  ...
  public createDesktop() {
    this.createFiles(
      this.snakeCasedFileName + "_desktop.dart",
      new Desktop(this.snakeCasedFileName, "Desktop").dartString
    );
  }
  ...
  public createTablet() {
    this.createFiles(
      this.snakeCasedFileName + "_tablet.dart",
      new Tablet(this.snakeCasedFileName, "Tablet").dartString
    );
  }
  ...
  private get snakeCasedFileName(): string {
      ...
      console.log("snakeCasedFileName", snakeCasedFileName);
